...
2. **Cache Vettoriale Statica (BENCH):** Al logout o riempimento della RAM, i dati passano nel file a blocchi fissi `reports_bench.txt` (50 slot da **352 byte**). Un contatore centralizzato traccia la prima riga disponibile. Al riempimento, il contatore si azzera (`counter = 0`), rendendo le celle disponibili ad essere sovrascritte.
